package com.capgemini.librarymanagementsystemjdbc1.controller;
...
import com.capgemini.librarymanagementsystemjdbc1.validation.Validation;
								...
								if(loginInfo.getRole().equals("admin")) {
									do {
										try {
											...
											case 6:
												try {
													LinkedList<BookInfo> info = service1.getBooksInfo();
